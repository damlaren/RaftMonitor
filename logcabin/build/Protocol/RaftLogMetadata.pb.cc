...
void protobuf_AssignDesc_build_2fProtocol_2fRaftLogMetadata_2eproto() {
  protobuf_AddDesc_build_2fProtocol_2fRaftLogMetadata_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "build/Protocol/RaftLogMetadata.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_build_2fProtocol_2fRaftLogMetadata_2eproto);
}
...
void protobuf_AddDesc_build_2fProtocol_2fRaftLogMetadata_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n$build/Protocol/RaftLogMetadata.proto\022!"
    "LogCabin.Protocol.RaftLogMetadata\"3\n\010Met"
    "adata\022\024\n\014current_term\030\001 \002(\004\022\021\n\tvoted_for"
    "\030\002 \002(\004", 126);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "build/Protocol/RaftLogMetadata.proto", &protobuf_RegisterTypes);
  Metadata::default_instance_ = new Metadata();
  Metadata::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_build_2fProtocol_2fRaftLogMetadata_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_build_2fProtocol_2fRaftLogMetadata_2eproto {
  StaticDescriptorInitializer_build_2fProtocol_2fRaftLogMetadata_2eproto() {
    protobuf_AddDesc_build_2fProtocol_2fRaftLogMetadata_2eproto();
  }
} static_descriptor_initializer_build_2fProtocol_2fRaftLogMetadata_2eproto_;
...
const Metadata& Metadata::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_build_2fProtocol_2fRaftLogMetadata_2eproto();
